...
Use these report-formatting rules:
- Use `###` for main sections and `####` for subsections.
- Keep critical information visible and use `<details><summary>...</summary>` for long evidence tables or logs.
- Include up to 3 workflow run links under `**References:**`, formatted as `[§12345](https://github.com/${{ github.repository }}/actions/runs/12345)`.
