...
| Token efficiency | Evaluate token totals, effective tokens (internal diagnostic metric), cache efficiency, turns, and AI credits consumption patterns | Top token and AI credit waste drivers |
